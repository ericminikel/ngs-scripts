...
# to run:
# bsub -o /humgen/atgu1/fs03/eminikel/sandbox/runXHMMjoboutput.out "bash runXHMM.bash -v -o /humgen/atgu1/fs03/eminikel/sandbox/2"
...
echo "1e-08   6       70      -3      1       0       1       3       1" | cat > params.txt
